...
// đây là bản full đã có menu được cóp từ main 102
#include <windows.h>
#include <string>
#include <SDL.h>
#include <SDL_image.h>
...
int ShowGameOver(SDL_Event g_event)
{
        ...
        for (int i =0;i<threats_list.size();i++)
        {
            ...
            if(bCol1 ||bCol2  )
            {
                ...
                else
                {
                    ...
                    // }
                    SDL_Delay(3000);
                    int check = ShowGameOver(g_event);
                    if(check ==1)
                    {
                        quit = true;
                    }
